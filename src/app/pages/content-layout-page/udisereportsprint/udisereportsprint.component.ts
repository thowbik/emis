...
@Component({
  selector: 'app-udisereportsprint',
  templateUrl: './udisereportsprint.component.html',
  styleUrls: ['./udisereportsprint.component.css']
})
export class UdisereportsprintComponent implements OnInit {
  form: FormGroup;
  ...
  initialValidator() {
    this.form = this.fb.group({
      ...
      'upgrad_prito_uprpri': new FormControl('', null), /* field missing */
      'upgrad_uprprito_sec': new FormControl('', null), /* field missing */
      'upgrad_secto_higsec': new FormControl('', null), /* field missing */
      ...
      'play_area_sqfts': new FormControl('', null),
      ...
      'schlreg_pfms': new FormControl('', null),
            ...
            'brlbks_prebys': new FormControl('', null),
            'brlbks_pregls': new FormControl('', null),
            'brlbks_uppbys': new FormControl('', null),
            'brlbks_uppgls': new FormControl('', null),
            'brlkit_prebys': new FormControl('', null),
            'brlkit_pregls': new FormControl('', null),
            'brlkit_uppbys': new FormControl('', null),
            'brlkit_uppgls': new FormControl('', null),
            'lvnkit_prebys': new FormControl('', null),
            'lvnkit_pregls': new FormControl('', null),
            'lvnkit_uppbys': new FormControl('', null),
            'lvnkit_uppgls': new FormControl('', null),
            'hearaid_prebys': new FormControl('', null),
            'hearaid_pregls': new FormControl('', null),
            'hearaid_uppbys': new FormControl('', null),
            'hearaid_uppgls': new FormControl('', null),
            'braces_prebys': new FormControl('', null),
            'braces_pregls': new FormControl('', null),
            'braces_uppbys': new FormControl('', null),
            'braces_uppgls': new FormControl('', null),
            'crthes_prebys': new FormControl('', null),
            'crthes_pregls': new FormControl('', null),
            'crthes_uppbys': new FormControl('', null),
            'crthes_uppgls': new FormControl('', null),
            'whlchr_prebys': new FormControl('', null),
            'whlchr_pregls': new FormControl('', null),
            'whlchr_uppbys': new FormControl('', null),
            'whlchr_uppgls': new FormControl('', null),
            'tricyle_prebys': new FormControl('', null),
            'tricyle_pregls': new FormControl('', null),
            'tricyle_uppbys': new FormControl('', null),
            'tricyle_uppgls': new FormControl('', null),
            'caliper_prebys': new FormControl('', null),
            'caliper_pregls': new FormControl('', null),
            'caliper_uppbys': new FormControl('', null),
            'caliper_uppgls': new FormControl('', null),
            'escort_prebys': new FormControl('', null),
            'escort_pregls': new FormControl('', null),
            'escort_uppbys': new FormControl('', null),
            'escort_uppgls': new FormControl('', null),
            'stipend_prebys': new FormControl('', null),
            'stipend_pregls': new FormControl('', null),
            'stipend_uppbys': new FormControl('', null),
            'stipend_uppgls': new FormControl('', null)
            /*newly created fields */
    });
  }
  ...
  getUdisePdfInfo() {
    ...
    this.SchoolsService.getUdisePdf(sch_id).subscribe(res => {
      ...
      this.anganchild = +res.result.schoolinfo.anganwadi_stu_b + + res.result.schoolinfo.anganwadi_stu_g;
      ...
      if (this.udisePdfDetails['spl_edtor'] == 1) {
        this.form.controls['spl_edtor'].setValue("Dedicated");
      }
      else if (this.udisePdfDetails['spl_edtor'] == 2) {
        this.form.controls['spl_edtor'].setValue("At cluster level");
      }
      else if (this.udisePdfDetails['spl_edtor'] == 3) {
        this.form.controls['spl_edtor'].setValue("NO");
      }
      else {
        this.form.controls['spl_edtor'].setValue("-");
      }
      ...
      if (this.udisePdfDetails['land_ownersip'] == 1) {
        this.form.controls['land_ownersip'].setValue("Private");
      }
      else if(this.udisePdfDetails['land_ownersip'] == 2) {
        this.form.controls['land_ownersip'].setValue("Rented/Leased");
      }
      else if(this.udisePdfDetails['land_ownersip'] == 3) {
        this.form.controls['land_ownersip'].setValue("Government");
      }
      else if(this.udisePdfDetails['land_ownersip'] == 4) {
        this.form.controls['land_ownersip'].setValue("Government school in a rent free building");
      }
      else if(this.udisePdfDetails['land_ownersip'] == 5) {
        this.form.controls['land_ownersip'].setValue("No Building");
      }
      else if(this.udisePdfDetails['land_ownersip'] == 7) {
        this.form.controls['land_ownersip'].setValue("Building Under Construction");
      }
      else {
        this.form.controls['land_ownersip'].setValue("School running in other Department Building");
      }

      if (this.udisePdfDetails['cmpwall_type'] == 1) {
        this.form.controls['cmpwall_type'].setValue("Pucca");
      }
      else if(this.udisePdfDetails['cmpwall_type'] == 2) {
        this.form.controls['cmpwall_type'].setValue("Pucca but broken");
      }
      else if(this.udisePdfDetails['cmpwall_type'] == 3) {
        this.form.controls['cmpwall_type'].setValue("Barbed wire fencing");
      }
      else if(this.udisePdfDetails['cmpwall_type'] == 4) {
        this.form.controls['cmpwall_type'].setValue("Hedges");
      }
      else if(this.udisePdfDetails['cmpwall_type'] == 5) {
        this.form.controls['cmpwall_type'].setValue("No boundry wall");
      }
      else if(this.udisePdfDetails['cmpwall_type'] == 6) {
        this.form.controls['cmpwall_type'].setValue("Others");
      }
       else if(this.udisePdfDetails['cmpwall_type'] == 7) {
        this.form.controls['cmpwall_type'].setValue("Partial");
      }
      else {
        this.form.controls['cmpwall_type'].setValue("Under Construction");
      }

      if (this.udisePdfDetails['drnkwater_source'] == 1) {
        this.form.controls['drnkwater_source'].setValue("Hand pumps");
      }
      else if(this.udisePdfDetails['drnkwater_source'] == 2) {
        this.form.controls['drnkwater_source'].setValue("Well");
      }
      else if(this.udisePdfDetails['drnkwater_source'] == 3) {
        this.form.controls['drnkwater_source'].setValue("Tap water");
      }
      else if(this.udisePdfDetails['drnkwater_source'] == 4) {
        this.form.controls['drnkwater_source'].setValue("RO purifier");
      }
      else if(this.udisePdfDetails['drnkwater_source'] == 5) {
        this.form.controls['drnkwater_source'].setValue("Packaged / Bottled water");
      }
      else {
        this.form.controls['drnkwater_source'].setValue("Others");
      }
  ...
  //     }
   ...
   getData(){ 
     debugger
     let schoolId = this.userSessionService.schoolId();
    this.SchoolsService.getPdfReport(schoolId).subscribe(pdfres =>{
      this.reportdata = pdfres.data;
