...
@Component({
  selector: 'app-repeaters-grade',
  templateUrl: './repeaters-grade.component.html',
  styleUrls: ['./repeaters-grade.component.css']
})
export class RepeatersGradeComponent implements OnInit {
