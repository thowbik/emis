...
@Component({
  selector: 'app-state-ceo-renewal-recognition',
  templateUrl: './state-ceo-renewal-recognition.component.html',
  styleUrls: ['./state-ceo-renewal-recognition.component.css']
})
export class StateCeoRenewalRecognitionComponent implements OnInit {
